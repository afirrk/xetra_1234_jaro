...
yourpath = os.path.dirname(os.path.abspath("/Users/jaroslavvomacka/Documents/Education/Writing production ready ETL pipelines in Python/xetra_project/xetra_1234_jaro/xetra/common")) #current filepath
